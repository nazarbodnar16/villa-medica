...
function my_assets() {
	...
	// Add Google Fonts
	wp_enqueue_style( 'montserrat', 'https://fonts.googleapis.com/css?family=Nunito+Sans:300,400,600,700,900&display=swap' );
	...
	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/development/css/css/bootstrap-grid.css', '1.0' );
