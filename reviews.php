...
<main id="main">
	...
	<div class="thanks-for-review-box">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="border">
						<div class="thanks-for-review">
							<div class="img">
								<img src="<?php echo get_template_directory_uri(); ?>/images/like.svg" alt="">
							</div>
							<h2>Спасибо!</h2>
							<p>Мы ценим Ваше мнение, комментарий успешно опубликован.</p>
						</div>
					</div>
				</div>
			</div>
